...
@interface TravelPhoneViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate,UIActionSheetDelegate>{
    ...
    NSMutableString * selectedPhoneNum;
}
