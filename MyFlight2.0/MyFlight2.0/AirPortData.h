...
@property(nonatomic,retain)NSString *cityCode; //城市码
@property(nonatomic,retain)NSString *cityPinYin; //城市拼音
@property(nonatomic,retain)NSString *weatherCode; //天气码
@property(nonatomic,retain)NSString *city_x;
@property(nonatomic,retain)NSString *city_y;
